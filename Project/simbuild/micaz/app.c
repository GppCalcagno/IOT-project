...
typedef nx_struct msg_pairing {
  ...
  nx_uint8_t key[22];
  nx_uint16_t id;
} __attribute__((packed)) msg_pairing;
...
typedef nx_struct msg_stop_paring {
  nx_uint16_t msg_type;
} __attribute__((packed)) msg_stop_paring;
...
typedef nx_struct msg_child {
  ...
  nx_uint16_t Y;
  nx_uint16_t status;
} __attribute__((packed)) msg_child;
...
typedef TMilli projectC$MilliTimer$precision_tag;
typedef TMilli projectC$InfoTimer$precision_tag;
typedef TMilli projectC$MissingTimer$precision_tag;
...
static void projectC$SplitControl$startDone(error_t error);
#line 138
static void projectC$SplitControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void projectC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void projectC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void projectC$MilliTimer$fired(void );
#line 83
static void projectC$InfoTimer$fired(void );
#line 83
static void projectC$MissingTimer$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t projectC$SplitControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t projectC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t projectC$Packet$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
uint8_t len);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t projectC$Random$rand16(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void projectC$MilliTimer$startPeriodic(uint32_t dt);
#line 78
static void projectC$MilliTimer$stop(void );
#line 64
static void projectC$InfoTimer$startPeriodic(uint32_t dt);
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t projectC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool projectC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void projectC$MissingTimer$startPeriodic(uint32_t dt);
#line 78
static void projectC$MissingTimer$stop(void );
# 30 "projectC.nc"
uint16_t projectC$ID[1000];
uint16_t projectC$associatedID[1000];
char projectC$key[1000][22];
bool projectC$locked[1000];
message_t projectC$packet[1000];

uint8_t projectC$X[1000];
uint8_t projectC$Y[1000];

uint8_t projectC$ChildStatus[1000];

uint8_t projectC$i[1000];

static inline void projectC$setKey(void );
static inline void projectC$sendBroadcast(void );
static inline void projectC$sendMessStopPairing(void );
static inline void projectC$createStatus(void );


static inline void projectC$sendChildStatus(void );

static char *projectC$statusToString(uint8_t ChildStatus);
...
static inline void projectC$MissingTimer$fired(void );





static inline void projectC$InfoTimer$fired(void );
...
static void projectC$AMSend$sendDone(message_t *msg, error_t err);
#line 261
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void projectC$MissingTimer$startPeriodic(uint32_t dt){
#line 64
...
inline static void projectC$MissingTimer$stop(void ){
#line 78
...
#line 78
#line 64
inline static void projectC$InfoTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 64
#line 78
inline static void projectC$MilliTimer$stop(void ){
#line 78
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t projectC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t projectC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
inline static void * projectC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 118
{
  ...
  if (!projectC$locked[sim_node()]) {

      msg_stop_paring *message = (msg_stop_paring *)projectC$Packet$getPayload(&projectC$packet[sim_node()], sizeof(msg_stop_paring ));

      __nesc_hton_uint16(message->msg_type.nxdata, 0);

      projectC$PacketAcknowledgements$requestAck(&projectC$packet[sim_node()]);


      if (projectC$AMSend$send(projectC$associatedID[sim_node()], &projectC$packet[sim_node()], sizeof(msg_stop_paring )) == SUCCESS) {
          projectC$locked[sim_node()] = 1;
          sim_log_debug(149U, "radio", "Bracelet %d sent a unicast message (ack requested) to stop pairing phase to Bracelet  %d (%s)\n", projectC$ID[sim_node()], projectC$associatedID[sim_node()], sim_time_string());
        }
    }
}
...
#line 261
{
  ...
  if (len == sizeof(msg_pairing )) {
      ...
      if (__nesc_ntoh_uint16(message->msg_type.nxdata) == 1) {


          for (projectC$i[sim_node()] = 0; projectC$i[sim_node()] < 22; projectC$i[sim_node()]++) {
              receivedKey[projectC$i[sim_node()]] = __nesc_ntoh_uint8(message->key[projectC$i[sim_node()]].nxdata);
            }

          if (strcmp(receivedKey, projectC$key[sim_node()]) == 0) {
              sim_log_debug(160U, "status", "Bracelet %d matched with Bracelet %d !(%s)\n", projectC$ID[sim_node()], __nesc_ntoh_uint16(message->id.nxdata), sim_time_string());
              projectC$associatedID[sim_node()] = __nesc_ntoh_uint16(message->id.nxdata);
              projectC$sendMessStopPairing();
            }
        }
    }
  ...
  if (len == sizeof(msg_stop_paring )) {
      ...
      if (__nesc_ntoh_uint16(message->msg_type.nxdata) == 0) {
          sim_log_debug(161U, "radio", "Bracelet %d has received a stop pairing message!(%s)\n", projectC$ID[sim_node()], sim_time_string());
          projectC$MilliTimer$stop();
          sim_log_debug(162U, "status", "Bracelet %d stopped the pairing phase!(%s)\n", projectC$ID[sim_node()], sim_time_string());


          if (projectC$ID[sim_node()] % 2 == 1) {

              sim_log_debug(163U, "timer", "Child Bracelet %d: Start Periodical Timer (%d ms) (%s)\n", projectC$ID[sim_node()], 10000, sim_time_string());
              projectC$InfoTimer$startPeriodic(10000);
            }
        }
    }
...
#line 308
      sim_log_debug(164U, "radio", "Parent Bracelet %d has received a INFO  message!(%s)\n", projectC$ID[sim_node()], sim_time_string());

      projectC$X[sim_node()] = __nesc_ntoh_uint16(message->X.nxdata);
      projectC$Y[sim_node()] = __nesc_ntoh_uint16(message->Y.nxdata);

      if (__nesc_ntoh_uint16(message->msg_type.nxdata) == 2) {
          if (__nesc_ntoh_uint16(message->status.nxdata) == 4) {
              sim_log_debug(165U, "status", "Parent Bracelet %d has received a FALL alarm: STATUS=%s, X=%d, Y=%d! (%s)\n", projectC$ID[sim_node()], projectC$statusToString(__nesc_ntoh_uint16(message->status.nxdata)), __nesc_ntoh_uint16(message->X.nxdata), __nesc_ntoh_uint16(message->Y.nxdata), sim_time_string());
            }

          projectC$MissingTimer$stop();
          projectC$MissingTimer$startPeriodic(60000);
        }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7652298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7652298) {
#line 78
    case 6:
#line 78
      __nesc_result = projectC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7652298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74d70a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74d70a0, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(166U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(167U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(168U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(169U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76638b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76638b0, msg, error);
#line 110
}
#line 110
...
inline static bool projectC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7652930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7652930, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t projectC$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void projectC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 185
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(152U, "radio", "Bracelet %d: Radio on (%s)!\n\n", projectC$ID[sim_node()], sim_time_string());
      sim_log_debug(153U, "timer", "Bracelet %d: Start Timer (%s)\n", projectC$ID[sim_node()], sim_time_string());
      projectC$MilliTimer$startPeriodic(7000);
    }
  else {
      sim_log_debug(154U, "radio", "Bracelet %d: Can't Start the Radio, retry! (%s)\n", projectC$ID[sim_node()], sim_time_string());
...
#line 113
  projectC$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 199
{
  sim_log_debug(155U, "radio", "Bracelet %d: Can't Start the Radio! (%s)\n", projectC$ID[sim_node()], sim_time_string());
}
...
#line 138
  projectC$SplitControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  projectC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74d96a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74d96a8) {
#line 100
    case 0U:
#line 100
      /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74d96a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 141
{
  ...
  if (!projectC$locked[sim_node()]) {
      ...
      msg_pairing *message = (msg_pairing *)projectC$Packet$getPayload(&projectC$packet[sim_node()], sizeof(msg_pairing ));

      __nesc_hton_uint16(message->msg_type.nxdata, 1);
      __nesc_hton_uint16(message->id.nxdata, projectC$ID[sim_node()]);

      for (projectC$i[sim_node()] = 0; projectC$i[sim_node()] < 22; projectC$i[sim_node()]++) {
          __nesc_hton_uint8(message->key[projectC$i[sim_node()]].nxdata, projectC$key[sim_node()][projectC$i[sim_node()]]);
        }

      if (projectC$AMSend$send(AM_BROADCAST_ADDR, &projectC$packet[sim_node()], sizeof(msg_pairing )) == SUCCESS) {
          projectC$locked[sim_node()] = 1;
          sim_log_debug(150U, "radio", "Bracelet %d sent a broadcast pairing message (%s)\n", projectC$ID[sim_node()], sim_time_string());
        }
    }
}
...
#line 211
{
  sim_log_debug(156U, "status", "Parent Bracelet %d receive a MISSING alarm. Last Pos: X=%d, Y=%d (%s)\n", projectC$ID[sim_node()], projectC$X[sim_node()], projectC$Y[sim_node()], sim_time_string());
}
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t projectC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 95
{
  uint8_t rnd = projectC$Random$rand16() % 10 + 1;

  if (rnd <= 3) {
      projectC$ChildStatus[sim_node()] = 1;
    }
  else {
#line 101
    if (rnd <= 6) {
        projectC$ChildStatus[sim_node()] = 2;
      }
    else {
#line 104
      if (rnd <= 9) {
          projectC$ChildStatus[sim_node()] = 3;
        }
      else {
#line 107
        if ((rnd = 10)) {
            projectC$ChildStatus[sim_node()] = 4;
          }
        }
      }
    }
#line 111
  projectC$X[sim_node()] = projectC$Random$rand16() % 100;
  projectC$Y[sim_node()] = projectC$Random$rand16() % 100;
}
...
#line 67
{
  projectC$createStatus();

  if (!projectC$locked[sim_node()]) {

      msg_child *message = (msg_child *)projectC$Packet$getPayload(&projectC$packet[sim_node()], sizeof(msg_child ));

      __nesc_hton_uint16(message->msg_type.nxdata, 2);
      __nesc_hton_uint16(message->X.nxdata, projectC$X[sim_node()]);
      __nesc_hton_uint16(message->Y.nxdata, projectC$Y[sim_node()]);
      __nesc_hton_uint16(message->status.nxdata, projectC$ChildStatus[sim_node()]);

      projectC$PacketAcknowledgements$requestAck(&projectC$packet[sim_node()]);


      if (projectC$AMSend$send(projectC$associatedID[sim_node()], &projectC$packet[sim_node()], sizeof(msg_child )) == SUCCESS) {
          projectC$locked[sim_node()] = 1;
          sim_log_debug(148U, "radio", "Child Bracelet %d send a unicast INFO message: Status (ack requested): %s, X=%d, Y=%d (%s)\n", projectC$ID[sim_node()], projectC$statusToString(projectC$ChildStatus[sim_node()]), projectC$X[sim_node()], projectC$Y[sim_node()], sim_time_string());
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb735a3a8){
#line 83
  switch (arg_0xb735a3a8) {
#line 83
    case 0U:
#line 83
      projectC$MilliTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      projectC$MissingTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      projectC$InfoTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb735a3a8);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(197U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(196U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(193U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(194U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(186U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(176U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(181U, "HplAtm128Timer0AsyncP", "TIFR is %hhx\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x36]);
          sim_log_debug(182U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(183U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(188U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 165
{
  if (projectC$ID[sim_node()] < 2) {
    strcpy(projectC$key[sim_node()], "D0oM6MyHqWigyH1paRl3");
    }
  else {
#line 169
    strcpy(projectC$key[sim_node()], "NmZQODR76wjmwgLNLq45");
    }
}
...
#line 173
{
  ...
  projectC$ID[sim_node()] = TOS_NODE_ID;
  projectC$setKey();

  sim_log_debug(151U, "boot", "Bracelet %d with Key: %s booted at time: %s .\n", projectC$ID[sim_node()], projectC$key[sim_node()], sim_time_string());
...
#line 55
{
  /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*projectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
#line 224
{
  ...
  if (&projectC$packet[sim_node()] == msg && err == SUCCESS) {

      if (projectC$Packet$payloadLength(msg) != sizeof(msg_pairing )) {

          if (projectC$PacketAcknowledgements$wasAcked(msg)) {
              sim_log_debug(157U, "radio", "Bracelet %d has received the message ACK!(%s)\n\n", projectC$ID[sim_node()], sim_time_string());
            }
          else 
#line 232
            {

              if (projectC$Packet$payloadLength(msg) == sizeof(msg_child )) {

                  projectC$PacketAcknowledgements$requestAck(msg);
                  if (projectC$AMSend$send(projectC$associatedID[sim_node()], msg, sizeof(msg_child )) == SUCCESS) {

                      sim_log_debug(158U, "radio", "ACK not Received: Child Bracelet %d send a unicast INFO message: Status: %s, X=%d, Y=%d (%s)\n", projectC$ID[sim_node()], projectC$statusToString(projectC$ChildStatus[sim_node()]), projectC$X[sim_node()], projectC$Y[sim_node()], sim_time_string());
                    }
                }


              if (projectC$Packet$payloadLength(msg) == sizeof(msg_stop_paring )) {

                  projectC$PacketAcknowledgements$requestAck(msg);
                  if (projectC$AMSend$send(projectC$associatedID[sim_node()], msg, sizeof(msg_pairing )) == SUCCESS) {

                      sim_log_debug(159U, "radio", "ACK not Received:Bracelet %d sent a unicast message to stop pairing phase to Bracelet %d (%s)\n", projectC$ID[sim_node()], projectC$associatedID[sim_node()], sim_time_string());
                    }
                }
            }
        }
  ...
  projectC$locked[sim_node()] = 0;
}

# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t projectC$Packet$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 285
  ...
  sim_log_debug(185U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(191U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(171U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(172U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(173U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(174U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(192U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(195U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(184U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module projectC */
  if (!strcmp(varname, "projectC$ID"))
  {
    *addr = (uintptr_t)&projectC$ID[__nesc_mote];
    *size = sizeof(projectC$ID[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$associatedID"))
  {
    *addr = (uintptr_t)&projectC$associatedID[__nesc_mote];
    *size = sizeof(projectC$associatedID[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$key"))
  {
    *addr = (uintptr_t)&projectC$key[__nesc_mote];
    *size = sizeof(projectC$key[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$locked"))
  {
    *addr = (uintptr_t)&projectC$locked[__nesc_mote];
    *size = sizeof(projectC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$packet"))
  {
    *addr = (uintptr_t)&projectC$packet[__nesc_mote];
    *size = sizeof(projectC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$X"))
  {
    *addr = (uintptr_t)&projectC$X[__nesc_mote];
    *size = sizeof(projectC$X[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$Y"))
  {
    *addr = (uintptr_t)&projectC$Y[__nesc_mote];
    *size = sizeof(projectC$Y[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$ChildStatus"))
  {
    *addr = (uintptr_t)&projectC$ChildStatus[__nesc_mote];
    *size = sizeof(projectC$ChildStatus[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectC$i"))
  {
    *addr = (uintptr_t)&projectC$i[__nesc_mote];
    *size = sizeof(projectC$i[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module projectC */
  memset((void *)&projectC$ID[__nesc_mote], 0, sizeof projectC$ID[__nesc_mote]);
  memset((void *)&projectC$associatedID[__nesc_mote], 0, sizeof projectC$associatedID[__nesc_mote]);
  memset((void *)&projectC$key[__nesc_mote], 0, sizeof projectC$key[__nesc_mote]);
  projectC$locked[__nesc_mote] = 0;
  memset((void *)&projectC$packet[__nesc_mote], 0, sizeof projectC$packet[__nesc_mote]);
  memset((void *)&projectC$X[__nesc_mote], 0, sizeof projectC$X[__nesc_mote]);
  memset((void *)&projectC$Y[__nesc_mote], 0, sizeof projectC$Y[__nesc_mote]);
  memset((void *)&projectC$ChildStatus[__nesc_mote], 0, sizeof projectC$ChildStatus[__nesc_mote]);
  memset((void *)&projectC$i[__nesc_mote], 0, sizeof projectC$i[__nesc_mote]);
