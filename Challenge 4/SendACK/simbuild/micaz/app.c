...
uint8_t sendAckC$rec_id[1000];
uint8_t sendAckC$receivedAck[1000];
...
#line 180
{
  ...
  if (len == sizeof(my_msg_t )) {
      ...
      sim_log_debug(160U, "radio", "Message received from Node : %d \n", TOS_NODE_ID);
      if (__nesc_ntoh_uint16(rcm->msg_type.nxdata) == 1) {
          sim_log_debug(161U, "radio", "Type = REQ, Counter=%d \n\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
        }
      else 
#line 207
        {
          sim_log_debug(162U, "radio", "Type = RES, Counter=%d, Value=%d \n\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata));
        }
    }
  return buf;
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb762a298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb762a298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb762a298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb762a930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb762a930, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(152U, "radio", "Radio on!\n");

      if (TOS_NODE_ID == 1) {
          sim_log_debug(153U, "timer", "Timer started for Node 1 (1000m).\n");
          sendAckC$MilliTimer$startPeriodic(1000);
        }
    }
  else {
      sim_log_debug(154U, "radio", "Can't Start the Radio, retry!\n");
...
#line 117
{
  sim_log_debug(155U, "radio", "Can't Start the Radio!\n");
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76308b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76308b0, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74cbca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74cbca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74cbca8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 68
      ...
      if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sendAckC$locked[sim_node()] = 1;
          sim_log_debug(150U, "radio", "REQ Packet n: %d sent at time: %s \n", sendAckC$counter[sim_node()], sim_time_string());
          sendAckC$counter[sim_node()]++;
        }
    }
}
...
#line 215
{
  ...
  sim_log_debug(163U, "radio", "Create RESPONSE to Packet n: %d !\n", sendAckC$counter[sim_node()]);

  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      sim_log_debug(164U, "radio", "ACK request settleds!\n");
    }
  ...
  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sendAckC$locked[sim_node()] = 1;
      sim_log_debug(165U, "radio", "RESP Packet n: %d sent at time: %s \n", sendAckC$counter[sim_node()], sim_time_string());
      sendAckC$counter[sim_node()]++;
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73493a8){
#line 83
  switch (arg_0xb73493a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73493a8);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74c8730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74c8730, addr, msg, len);
#line 80
...
#line 93
{
  sim_log_debug(151U, "boot", "Application %d booted at time: %s .\n", TOS_NODE_ID, sim_time_string());
  sendAckC$rec_id[sim_node()] = TOS_NODE_ID;
...
#line 134
{
  ...
  sendAckC$locked[sim_node()] = 0;
  if (TOS_NODE_ID == 1) {

      if (&sendAckC$packet[sim_node()] == buf && err == SUCCESS) {
          my_msg_t *rcm = (my_msg_t *)sendAckC$Packet$getPayload(buf, sizeof(my_msg_t ));

          if (sendAckC$PacketAcknowledgements$wasAcked(buf)) {
              sendAckC$receivedAck[sim_node()]++;
              sim_log_debug(156U, "radio", "Packet ACK n: %d received - Number of ACK: %d!\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata), sendAckC$receivedAck[sim_node()]);

              if (sendAckC$receivedAck[sim_node()] == sendAckC$last_digit[sim_node()]) {
                  sim_log_debug(157U, "timer", "Timer Stopped, Ack Received: %d !\n", sendAckC$receivedAck[sim_node()]);
            ...
            {
              sim_log_debug(158U, "radio", "Packet ACK n:  %d NOT received !\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
            }
        }
    }
  else 
...
#line 170
          if (sendAckC$PacketAcknowledgements$wasAcked(buf)) {
              sendAckC$receivedAck[sim_node()]++;
              sim_log_debug(159U, "radio", "Packet REQUEST n: ACK %d received !\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
            }
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$rec_id"))
  {
    *addr = (uintptr_t)&sendAckC$rec_id[__nesc_mote];
    *size = sizeof(sendAckC$rec_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$receivedAck"))
  {
    *addr = (uintptr_t)&sendAckC$receivedAck[__nesc_mote];
    *size = sizeof(sendAckC$receivedAck[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module sendAckC */
  sendAckC$last_digit[__nesc_mote] = 3;
  sendAckC$counter[__nesc_mote] = 0;
  memset((void *)&sendAckC$rec_id[__nesc_mote], 0, sizeof sendAckC$rec_id[__nesc_mote]);
  sendAckC$receivedAck[__nesc_mote] = 0;
  memset((void *)&sendAckC$packet[__nesc_mote], 0, sizeof sendAckC$packet[__nesc_mote]);
  sendAckC$locked[__nesc_mote] = 0;
